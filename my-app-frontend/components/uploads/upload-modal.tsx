...
export function UploadModal({ isOpen, onClose }: UploadModalProps) {
  ...
  const handleDrop = useCallback(
    (e: React.DragEvent) => {
      ...
      const logFile = files.find((file) => file.name.endsWith(".log") || file.name.endsWith(".txt"))
      ...
      if (logFile) {
        ...
        toast({
          ...
          description: "Please select a .log or .txt file",
          variant: "destructive",
        })
      }
    },
            ...
            <div className="text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Your file is being processed and will appear in the uploads list shortly.
                </p>
              </div>
