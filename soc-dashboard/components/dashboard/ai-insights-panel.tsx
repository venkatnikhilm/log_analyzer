    ...
    <Sheet open={isOpen} onOpenChange={onClose}>
      <SheetContent className="w-[600px] sm:max-w-[600px]">
        <SheetHeader>
          ...
          <SheetDescription>
            AI-powered threat detection for {fileName || 'uploaded file'}
          </SheetDescription>
        </SheetHeader>

        <div className="mt-6 space-y-4 overflow-y-auto pr-2 flex-1 max-h-[calc(100vh-120px)]">
          <div className="grid grid-cols-1 gap-4">
            <Card>
              <CardContent className="pt-4">
                <div className="text-2xl font-bold text-red-600">{threatCount}</div>
          ...
          <div className="space-y-3">
            <h3 className="text-lg font-semibold">Threat Findings</h3>
            {insights.length === 0 ? (
              <Card>
                <CardContent className="pt-6 text-center">
                  <Shield className="mx-auto h-12 w-12 text-muted-foreground mb-4" />
                  <p className="text-muted-foreground">No threats detected. Your logs appear to be clean.</p>
                </CardContent>
              </Card>
            ) : (
              insights.map((insight, index) => (
